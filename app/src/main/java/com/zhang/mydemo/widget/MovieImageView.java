...
//    private static final boolean DB_DETAIL = false;  
    private static final String LOG_TAG = "MovieImageView";  
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {  
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN) {
			...
			onMeasureRe(widthMeasureSpec, heightMeasureSpec);
		}
    }
	
	@TargetApi(Build.VERSION_CODES.JELLY_BEAN)
	private void onMeasureRe(int widthMeasureSpec, int heightMeasureSpec){
		syncParentParameter();  
