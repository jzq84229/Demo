package com.zhang.mydemo.droidplugin;
//
...
//
//public class DroidPluginActivity extends BaseActivity {
//    private static final String LOG_TAG = DroidPluginActivity.class.getSimpleName();
//
...
//                        sb.append(ms).append("\r\n");
//                        Log.e(LOG_TAG, "packageName=%s, name=%s group=%s protectionLevel=%s", permission.packageName, permission.name, permission.group, permission.protectionLevel);
//                    }
//
//                    FileWriter w = null;
//                    try {
