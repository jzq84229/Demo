package com.zhang.imagepicker.ui;
...
import com.zhang.imagepicker.DataHolder;
import com.zhang.imagepicker.ImageDataSource;
import com.zhang.imagepicker.ImagePicker;
import com.zhang.imagepicker.R;
import com.zhang.imagepicker.bean.ImageFolder;
import com.zhang.imagepicker.bean.ImageItem;
import com.zhang.imagepicker.ui.adapter.ImageFolderAdapter;
import com.zhang.imagepicker.ui.adapter.ImageRecyclerAdapter;
import com.zhang.imagepicker.view.FolderPopUpWindow;

import java.util.ArrayList;
import java.util.List;

public class ImageGridActivity extends ImageBaseActivity implements ImageDataSource.OnImageLoadedListener, ImagePicker.OnImageSelectedListener, View.OnClickListener, ImageRecyclerAdapter.OnImageItemClickListener {
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.btn_back) {
            ...
            intent.putExtra(ImagePicker.EXTRA_RESULT_ITEMS, imagePicker.getSelecteImages());
            setResult(ImagePicker.RESULT_CODE_ITEMS, intent);   //多选不允许裁剪裁剪，返回数据
            finish();
        } else if (i == R.id.btn_dir) {
