...
public class LogUtils {
    ...
    public static String TAG = "ACMED_IM";
    public static final String MSG = "log msg is null.";
    public static final String LOCAL_POWER_PATH = FileUtils.getExternalStorePath() + "/" + "ecsdk_log.txt";
    ...
    public static synchronized void appendByBufferedWriter(String content) {
        ...
        try {
            ...
            bw.flush();
            bw.close();
            LogUtils.d("[FileAccessor - appendContent] append finished.");
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            if (bw != null) {
    ...
    public static String getLogUtilsTag(Class<? extends Object> clazz) {
        return LogUtils.TAG + "." + clazz.getSimpleName();
    }
}
