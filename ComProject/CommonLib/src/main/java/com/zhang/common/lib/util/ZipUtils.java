...
public class ZipUtils {
     ...
     * @throws Exception
     */
    public static String UnZipFolder(InputStream inputStream, String outPathString) throws Exception {
        ...
        while ((zipEntry = inZip.getNextEntry()) != null) {
            ...
            if (zipEntry.isDirectory()) {
                ...
                Log.d("BJJ","copyAssetsUnzip UnZipFolder:"+(outPathString + File.separator + szName));
                file.createNewFile();
