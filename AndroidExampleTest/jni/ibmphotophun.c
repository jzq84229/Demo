...
Pixel operation
*/
JNIEXPORT void JNICALL Java_com_zhang_example_IBMPhotoPhun_convertToGray(JNIEnv * env, jobject  obj, jobject bitmapcolor,jobject bitmapgray)
{
...
Matrix operation
*/
JNIEXPORT void JNICALL Java_com_zhang_example_IBMPhotoPhun_findEdges(JNIEnv * env, jobject  obj, jobject bitmapgray,jobject bitmapedges)
{
    AndroidBitmapInfo  infogray;
    void*              pixelsgray;
...
Pixel Operation
*/
JNIEXPORT void JNICALL Java_com_zhang_example_IBMPhotoPhun_changeBrightness(JNIEnv * env, jobject  obj, int direction,jobject bitmap)
{
    AndroidBitmapInfo  infogray;
    void*              pixelsgray;
    int                ret;
