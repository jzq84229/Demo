...
package com.zhang.demo.zxing.qrcode.decode;
...
//    }
    ...
    switch (decodeMode) {
      case BARCODE_MODE:
        decodeFormats.addAll(DecodeFormatManager.getBarCodeFormat());
        break;
      case QRCODE_MODE:
        decodeFormats.addAll(DecodeFormatManager.getQrCodeFormat());
        break;
      case ALL_MODE:
        decodeFormats.addAll(DecodeFormatManager.getBarCodeFormat());
        decodeFormats.addAll(DecodeFormatManager.getQrCodeFormat());
