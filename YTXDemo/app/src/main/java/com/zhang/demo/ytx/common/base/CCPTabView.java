...
import com.zhang.demo.ytx.common.CCPAccessibilityManager;
...
public class CCPTabView extends ViewGroup {
    private static final String LOG_TAG = CCPTabView.class.getSimpleName();
    ...
    /** The tab tips */
    private TextView mTabUnreadTips;
    /** The tab image. */
    ...
    public CCPTabView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        tips.setTextColor(getResources().getColor(R.color.white));
