...
import com.zhang.demo.ytx.common.dialog.ECAlertDialog;
...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    public void collectCrashDeviceInfo(Context ctx) {
        try {
            ...
            LogUtil.e(LOG_TAG, "Error while collect package info" + e.getMessage());
            e.printStackTrace();
        }
        ...
        for (Field field : fields) {
            try {
                ...
                LogUtil.e(LOG_TAG, "Error while collect crash info" + e.getMessage());
            }
        }
    }
    ...
    private String saveCrashInfoToFile(Throwable ex) {
        ...
        printWriter.close();
        mDeviceCrashInfo.put("EXPTION", ex.getLocalizedMessage());
        ...
        try {
            ...
            LogUtil.e(LOG_TAG, "an error occured while writing report file..." + e.getMessage());
        }
        return null;
    }
