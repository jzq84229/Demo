...
import com.zhang.demo.ytx.common.SwipeTranslucentMethodUtils;
...
//        mDragHelper.setMaxVelocity(minVel * 3f);
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        try {
            LogUtil.d(LOG_TAG, "onInterceptTouchEvent");
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        LogUtil.d(LOG_TAG, "onTouchEvent");
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        LogUtil.d(LOG_TAG, "drawChild " + drawingTime);
    ...
    public void markTranslucent(boolean translucent) {
        LogUtil.i(LOG_TAG, "markTranslucent : " + translucent);
    ...
    public void computeScroll() {
        ...
        LogUtil.d(LOG_TAG , "computeScroll :: mScrimOpacity " + mScrimOpacity);
    ...
    private class ViewDragCallback extends ViewDragHelper.Callback implements MethodInvoke.OnSwipeInvokeResultListener {
        private  final String TAG = ViewDragCallback.class.getSimpleName();
        private int mTemp = 0;
        ...
        public boolean tryCaptureView(View child, int pointerId) {
            ...
            LogUtil.d(TAG, "tryCaptureView i :" + pointerId + " ,edgeTouched:" + edgeTouched);
            return edgeTouched;
        }
        ...
        public void onViewDragStateChanged(int state) {
            ...
            if (state == ViewDragHelper.STATE_DRAGGING && (SwipeBackLayout.this.getContext() instanceof Activity) && !mTranslucent && !mRequestTranslucent) {
