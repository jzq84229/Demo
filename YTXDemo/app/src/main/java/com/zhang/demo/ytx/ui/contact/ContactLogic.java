...
import com.zhang.demo.ytx.common.utils.BitmapUtil;
import com.zhang.demo.ytx.common.utils.DemoUtils;
import com.zhang.demo.ytx.common.utils.DialNumberMap;
import com.zhang.demo.ytx.common.utils.ECPropertiesUtil;
...
import com.zhang.demo.ytx.core.ECArrayLists;
import com.zhang.demo.ytx.core.Phone;
import com.zhang.demo.ytx.core.comparator.PyComparator;
...
public class ContactLogic {
    ...
    public static Bitmap getPhoto(String username) {
        ...
        try {
            ...
            if (username.startsWith("mobilePhoto://")) {
                ...
                bitmap = DemoUtils.decodeStream(CCPAppManager.getContext().getAssets().open("avatar/" + username),
    ...
    /**
     * 初始化联系人列表
     * @return      ArrayList<ECContacts>
     */
    public static ArrayList<ECContacts> initContacts() {
        ArrayList<ECContacts> list = new ArrayList<>();
...
//							char c = name.charAt(i);
    ...
    public static void getMobileContactPhoto(ECContacts contact) {
        try {
            ...
            DemoUtils.saveBitmapToLocal(new File(FileAccessor.getAppContextPath(), contact.getContactid()), bitmap);
    ...
    /**
     * 根据count数生成合成图片中个图片位置信息的BitmapUtil.InnerBitmapEntity数组
     * @param count     合成图片数
     * @return          List<BitmapUtil.InnerBitmapEntity>
     */
