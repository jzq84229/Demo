...
//    private int mItemSize;
    ...
    public CCPLauncherUITabView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        addView(layout, new RelativeLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
        ...
        RelativeLayout.LayoutParams imageViewLayoutParams =
                new RelativeLayout.LayoutParams(-1, DensityUtil.fromDPToPix(getContext(), 3));
...
//        mItems = getResources().getString(itemsId);
//        mItemSize = mItems.length;
    ...
    public final void resetTabViewDesc() {
        if (mMainTabView == null || mSecondTabView == null || mThirdTabView == null || mFourTabView == null) {
            return;
        }
