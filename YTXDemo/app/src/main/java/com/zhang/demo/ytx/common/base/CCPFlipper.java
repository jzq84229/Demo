...
public class CCPFlipper extends ViewGroup {
    Interpolator mFlippterInterpolator;
    Scroller mScroller;
    ...
    public CCPFlipper(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initFlipper(context);
    }

    public void initFlipper(Context context) {
        mFlippterInterpolator = new FlipperInterPolator();
        mScroller = new Scroller(getContext(), mFlippterInterpolator);
    ...
    public void setOnFlipperListener(OnFlipperPageListener l) {
     ...
     * @date 2013-12-24
     */
    private class FlipperInterPolator implements Interpolator {
    ...
    public interface OnCCPFlipperMeasureListener {
         ...
         *                         {@link android.view.View.MeasureSpec}.
         */
        void onCCPFlipperMeasure(int widthMeasureSpec, int heightMeasureSpec);
    }
